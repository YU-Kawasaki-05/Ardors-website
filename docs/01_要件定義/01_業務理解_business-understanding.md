...
| 4   | 自作プロダクトと現在のサービス提供の関係が伝わりにくい                            | 見込み顧客、協業候補         | サイト閲覧時ごと            | 中     |
...
| P0     | プロダクト・実績の公開     | Productsページや関連リンクへの遷移が発生する（定性評価）       |
...
- 自作プロダクトの紹介ページまたは紹介セクション（リンク導線中心）
- 問い合わせ導線（フォーム）
- 日本語/英語の2言語対応
- Note RSS 連携セクション
- GitHub への導線
...
- 将来の拡張（採用ページ/CMS強化/プロダクト導線強化）を見据え、変更容易性をP0要件として扱う。
