...
| ファイル | 内容 |
|---------|------|
| [00_サマリー_summary.md](./00_サマリー_summary.md) | このファイル。全体像・並列ガイド・ID対応表 |
| [01_共通ブロック_common-blocks.md](./01_共通ブロック_common-blocks.md) | 全プロンプト末尾に付与する共通ブロック |
...
| [08_backlog_p1-cms.md](./08_backlog_p1-cms.md) | Backlog (P1): CMS・Note RSS・GA4 |
...
- **直列**: `ARD-19`（GA4）は `ARD-18` の `<head>` 構造確定後に実施。
...
| ARD-18 | FR-71 | OGP メタタグ + 構造化データ | Sprint 4 |
| ARD-19 | FR-32 | GA4 基本統合 | Sprint 4 |
| ARD-20 | BR-40〜43, FR-70 | セキュアヘッダー (CSP/HSTS 等) | Sprint 5 |
