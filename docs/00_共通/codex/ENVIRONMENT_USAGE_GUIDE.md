# Ardors Codex Environment Usage Guide
...
- `~/.codex/prompts/req-phase1.md`
- `~/.codex/prompts/req-phase2.md`
- `~/.codex/prompts/req-phase3.md`
...
~/.local/bin/pre-commit install --hook-type pre-push
```
